        ...
        >
          <div className={styles.recapWrapper}>
            <div className={styles.recapTop}>
              ...
              <div className={styles.recapBtn} onClick={onClickWrite}>작성</div>
            </div>
              ...
              <div className={styles.middleWork}>
                ...
                <div className={styles.middleBox}>
                  ...
                  <div className={styles.middleSubBox}>
                    ...
                    {!write && <div className={styles.notWrite}>아직 작성 전이에요.</div>}
            ...
            <div className={styles.bottom}>
              ...
              <div className={styles.bottominputBox}>
                ...
                {!write && <div className={styles.bottomNotWrite}>아직 작성 전이에요.</div>}
                {write && <input className={styles.bottomInput} placeholder='오늘 한 일을 작성해주세요.'></input>}
                
              </div>
              <div className={styles.bottominputBox}>
              <div className={styles.bottomSub}>W 배운 점</div>
              {!write && <div className={styles.bottomNotWrite}>아직 작성 전이에요.</div>}
              {write &&               <input className={styles.bottomInput} placeholder='오늘 배운 점을 작성해주세요.'></input>}
              </div>
              <div className={styles.bottominputBox}>
              <div className={styles.bottomSub}>T 다음에 할 일</div>
              {!write && <div className={styles.bottomNotWrite}>아직 작성 전이에요.</div>}
              {write && <input className={styles.bottomInput} placeholder='다음에 할 일을 작성해주세요.'></input>}
